...
const { EmbedBuilder, ButtonStyle, ActionRowBuilder, ButtonBuilder, PermissionsBitField, EmbeBuilder } = require("discord.js")
...
//   client.channels.cache.get("1092431233667051572").safeSend({ content: `Hallo selamat datang ${member}`, embeds: [welcome]}).catch(() => { })
//   });
