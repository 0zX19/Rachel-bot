...
if (message.content.match("kiss") || message.content.match("Kiss")) {
  if (message.guild.members.cache.get(client.user.id).permissionsIn(message.channel).has(PermissionsBitField.Flags.SendMessages)) {
      return await message.reply("https://cdn.discordapp.com/emojis/1185361211144016045.gif?size=80&quality=losslesshttps://cdn.discordapp.com/emojis/1185361225849258095.gif?size=80&quality=lossless").catch(() => { });
  };
};
